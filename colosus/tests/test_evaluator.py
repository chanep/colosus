...
class EvaluatorTestCase(unittest.TestCase):
    ...
    def test_evaluate(self):
        ...
        config.player2_config.state_config.policy_offset = -0.75
        evaluator = Evaluator(config)
        # xxc_27_1100_1600
        evaluator.evaluate(200, 256, pos, "xxc_27_1100_1600.h5", "cpon_46_5000_800.h5")

        print("----------------------------------------------------")
        print("c_45_10100_800")
        evaluator.evaluate(200, 256, pos, "c_45_10100_800.h5", "cpon_46_5000_800.h5")

        print("----------------------------------------------------")
        print("cta_46_5000_800")
        evaluator.evaluate(200, 256, pos, "cta_46_5000_800.h5", "cpon_46_5000_800.h5")
        ...
        evaluator.evaluate(200, 256, pos, "cpo_46_5000_800.h5", "cpon_46_5000_800.h5")
