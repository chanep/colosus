...
class SelfPlayTestCase(unittest.TestCase):
    ...
    def test_train_multi(self):
        ...
        print("training c_21_1200_1600.h5...")
        train_filename = "c_21_1200_1600.dat"
        weights_filename = "c_21_1200_1600.h5"
        prev_weights_filename = "c_20_1000_1600.h5"
        trainer_config = TrainerConfig()
